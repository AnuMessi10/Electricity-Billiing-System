...
public class new_customer extends JFrame implements ActionListener
{
    ...
    new_customer()
    {
        ...
        ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("icon/reg.png"));
        Image i3 = ic1.getImage().getScaledInstance(192, 192,Image.SCALE_DEFAULT);
        ImageIcon ic2 = new ImageIcon(i3);
        l8 = new JLabel(ic2);
        
        add(l8,"West");
        //for changing the color of the whole color
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String q1 = "insert into customer values('"+a+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"')";
